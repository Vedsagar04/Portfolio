...
const Navbar = () => {
    ...
    return (
        <div className="navbar">
            <img src={logo} alt="VED" className="logo"/>
            <img src={menu_open} onClick={openMenu} alt="menu" className="nav-mob-open"/>
            <ul ref={menuRef} className="nav-menu">
                <img src={menu_close} onClick={closeMenu} alt="menu" className="nav-mob-close" />
                ...
                <li><AnchorLink className='anchor-link' offset={50} href="#work"><p onClick={() => setMenu("portfolio")}>Portfolio</p></AnchorLink>{menu==="portfolio"?<img src={underline} alt="underline" />:""}</li>
